...
function Landing() {
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 px-6 pt-10 pb-10 max-w-md mx-auto w-full relative">
      ...
      <section className="px-6 pb-10 pt-12 max-w-md mx-auto w-full bg-background rounded-t-3xl relative z-0">
