    ...
    <div>
      <header className="px-5 pt-8 pb-4 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Group chats unlock when your Gathr confirms.</p>
        </div>
      ...
      <div className="px-5 space-y-2">
        <Link to="/messages" className="block rounded-2xl border border-border p-3 bg-gradient-brand-soft">
          ...
          <div className="text-[11px] text-muted-foreground">1:1 chats with your Linkup connections</div>
        </Link>
