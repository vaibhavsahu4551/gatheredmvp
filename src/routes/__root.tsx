...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HUDDL — Meet verified strangers, plan real hangouts" },
      { name: "description", content: "HUDDL is a group-only meetup app for verified 18+ users to plan gaming, coffee, dinner, movies, treks and evening hangouts together." },
      { name: "theme-color", content: "#ffffff" },
      { property: "og:title", content: "HUDDL — Meet verified strangers, plan real hangouts" },
      { property: "og:description", content: "HUDDL is a group-only meetup app for verified 18+ users to plan gaming, coffee, dinner, movies, treks and evening hangouts together." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "HUDDL — Meet verified strangers, plan real hangouts" },
      { name: "twitter:description", content: "HUDDL is a group-only meetup app for verified 18+ users to plan gaming, coffee, dinner, movies, treks and evening hangouts together." },
