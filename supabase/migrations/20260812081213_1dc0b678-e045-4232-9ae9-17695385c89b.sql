...
RETURNS TABLE(id uuid, full_name text, dob date, gender text, city text, bio text, interests text[], photos text[], onboarding_complete boolean, created_at timestamptz, updated_at timestamptz, pride_opt_in boolean, subscription_tier text, premium_expires_at timestamptz, early_access boolean, instagram_handle text, spotify_url text, x_handle text, height_cm integer, profession text, smoking text, drinking text, is_verified boolean)
LANGUAGE sql
STABLE
